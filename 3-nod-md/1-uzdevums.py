...
def number_modifications( phonebook, name, new_number = None):
    if new_number:
        phonebook[name] = new_number
    elif (new_number == None):
        phonebook.pop(name)
    else:
        print('Well, this was unexpected.')

number_modifications(Janis, 'Martins', '041123400') # TODO 
number_modifications(Andris, 'Martins', '041123400') # TODO 
## Atkomentēt assert testu, lai pārbaudītu rezultātu
...
Andris = Andris # TODO
number_modifications(Andris, 'Toms', '041999888') # TODO
## Atkomentēt assert testu, lai pārbaudītu rezultātu 
...
Janis = Janis # TODO
number_modifications(Janis, 'Santa')
## Atkomentēt assert testu, lai pārbaudītu rezultātu
